...
if($status > 0){
    ...
    if($rows != null){
        ...
        $sql="update [THAccountsDB].[dbo].[AccountsInfo] set Compellation = '".$name."',PassPortID = '".$h2['passportid']."',infoMobile = '".$h2['infomobile']."',RegisterMobile='".$h2['infomobile']."',[isPerfect] =1 where UserId = ".$h2['userid']." ";
